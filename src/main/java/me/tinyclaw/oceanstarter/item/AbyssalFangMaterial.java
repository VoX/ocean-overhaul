 ...
 * Boss-gated: repaired with {@link OceanStarter#MEGALODON_TOOTH} (the Megalodon drop), so the trophy ties
 ...
 * instance ({@link OceanStarter#ABYSSAL_FANG_MATERIAL}).</p>
 *
...
public class AbyssalFangMaterial implements ToolMaterial {
	...
	public Ingredient getRepairIngredient() {
		return Ingredient.ofItems(OceanStarter.MEGALODON_TOOTH);
	}
}
