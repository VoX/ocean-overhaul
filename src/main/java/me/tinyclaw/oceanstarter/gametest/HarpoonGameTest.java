...
public class HarpoonGameTest implements FabricGameTest {
	...
	public void harpoonThrowWearsOneDurabilityAndConsumesHeldStack(TestContext context) {
		...
		ItemStack held = new ItemStack(OceanStarter.HARPOON);
	...
	public void harpoonDealtDamageNbtRoundTrips(TestContext context) {
		...
		HarpoonEntity fresh = new HarpoonEntity(context.getWorld(), player, new ItemStack(OceanStarter.HARPOON));
		...
		HarpoonEntity armed = new HarpoonEntity(context.getWorld(), player, new ItemStack(OceanStarter.HARPOON));
		...
		HarpoonEntity loaded = new HarpoonEntity(context.getWorld(), player, new ItemStack(OceanStarter.HARPOON));
