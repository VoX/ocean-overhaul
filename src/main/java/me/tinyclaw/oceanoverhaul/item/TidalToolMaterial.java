...
/**
 * The "Tidal" tool tier — an iron-plus material crafted from {@link OceanOverhaul#ABYSSAL_PEARL}.
 *
...
public class TidalToolMaterial implements ToolMaterial {
	...
	public Ingredient getRepairIngredient() {
		return Ingredient.ofItems(OceanOverhaul.ABYSSAL_PEARL);
	}
}
