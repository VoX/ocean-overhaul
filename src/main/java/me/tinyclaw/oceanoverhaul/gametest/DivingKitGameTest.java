...
public class DivingKitGameTest implements FabricGameTest {
	...
	public void divingPiecesGrantTheirEffectsWhenWorn(TestContext context) {
		...
		wearer.equipStack(EquipmentSlot.FEET, new ItemStack(OceanOverhaul.FLIPPERS));
		wearer.equipStack(EquipmentSlot.CHEST, new ItemStack(OceanOverhaul.OXYGEN_TANK));
		wearer.equipStack(EquipmentSlot.HEAD, new ItemStack(OceanOverhaul.DEEP_SEA_HELMET));
		context.assertTrue(
				wearer.getEquippedStack(EquipmentSlot.FEET).getItem() == OceanOverhaul.FLIPPERS
						&& wearer.getEquippedStack(EquipmentSlot.CHEST).getItem() == OceanOverhaul.OXYGEN_TANK
						&& wearer.getEquippedStack(EquipmentSlot.HEAD).getItem() == OceanOverhaul.DEEP_SEA_HELMET,
	 ...
	 * {@link ArmorItem} on the shared {@link OceanOverhaul#DIVING_ARMOR} material and sit in the slot
	...
	public void divingArmorMaterialValuesAndSlots(TestContext context) {
		assertDivingArmor(context, OceanOverhaul.FLIPPERS, ArmorItem.Type.BOOTS);
		assertDivingArmor(context, OceanOverhaul.OXYGEN_TANK, ArmorItem.Type.CHESTPLATE);
		assertDivingArmor(context, OceanOverhaul.DEEP_SEA_HELMET, ArmorItem.Type.HELMET);
		context.assertTrue(
				OceanOverhaul.DIVING_ARMOR != OceanOverhaul.TIDAL_ARMOR,
	...
	private static void assertDivingArmor(TestContext context, Item item, ArmorItem.Type expectedType) {
		...
		context.assertTrue(
				armor.getMaterial() == OceanOverhaul.DIVING_ARMOR,
